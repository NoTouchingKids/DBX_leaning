...
# Use `/api/healthz`. The Apps ingress answers the bare `/healthz` itself —
# 200, empty body, never forwarded — so it is unreadable in production. The
# old path stays because the docs name it in a dozen places.
