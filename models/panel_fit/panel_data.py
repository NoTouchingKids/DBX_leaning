...
Why a loader here rather than in ``models/_data/datasets.py``: that module's
...
_COUNTRIES: tuple[tuple[str, str | None], ...] = (
    ...
    ("Ireland", "IRL"), ("Italy", "ITA"), ("Japan", "JPN"), ("Kenya", "KEN"),
    ("Malaysia", "MYS"), ("Mexico", "MEX"), ("Morocco", "MAR"), ("Netherlands", "NLD"),
    ...
    ("World", None), ("Sub-Saharan Africa", None),
)
...
def _country_rows(
    ...
    for index, year in enumerate(years):
        ...
        if kind == "all_null":
            ...
            # `models/README.md` says never to assume a column is non-null.
